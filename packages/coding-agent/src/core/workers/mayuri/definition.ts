...
export const MAYURI_WORKER: NamedWorkerDefinition = {
	...
	systemPrompt:
		"Work as a web researcher. Prefer current primary or vendor sources when readily available, use the supplied local date to judge freshness, cite URLs or stable permalinks, distinguish evidence from inference, and stop once the task has enough support. Local project inspection belongs to Aizen.",
};
