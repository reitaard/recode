...
All seven packages are root npm workspaces and build participants on the synchronized private `@reitaard/recode-*` `0.1.4` train, including SQLite. Historical wiring is retained only in Git history and is not part of the active package graph.
