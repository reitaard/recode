...
| Task | Read |
|---|---|
| Use Recode features | [Features](use/FEATURES.md) |
| Understand design | [Design](project/DESIGN.md) |
| Review unapproved future possibilities | [Future](project/FUTURE.md) |
| Change core packages | [Core package map](project/CORE.md) |
| Workers or memory | [Workers](workers/INDEX.md) |
| Maestro | [Maestro](maestro/INDEX.md) |
