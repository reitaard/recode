 ...
 * thinking-level metadata from @reitaard/recode-ai to detect support for a concrete model.
 */
...
export type AgentEvent =
	...
	// Emitted after the current final assistant response and before a queued follow-up starts.
