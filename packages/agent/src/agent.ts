...
export class Agent {
	...
	/** Maximum provider calls allowed in each independent run. */
	...
	constructor(options: AgentOptions) {
		...
		this.streamFn = runtimeOptions.streamFn ?? getDefaultStreamFn(streamSimple);
		...
		this.maxIterations = runtimeOptions.maxIterations;
