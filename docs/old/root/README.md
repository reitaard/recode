...
* **[@reitaard/repi-coding-agent](packages/coding-agent)**: Interactive coding agent CLI
* **[@reitaard/repi-agent-core](packages/agent)**: Agent runtime with tool calling and state management
* **[@reitaard/repi-ai](packages/ai)**: Unified multi-provider LLM API (OpenAI, Anthropic, Google, …)
...
| Package | Description |
|---------|-------------|
| **[@reitaard/repi-ai](packages/ai)** | Unified multi-provider LLM API (OpenAI, Anthropic, Google, etc.) |
| **[@reitaard/repi-agent-core](packages/agent)** | Agent runtime with tool calling and state management |
| **[@reitaard/repi-coding-agent](packages/coding-agent)** | Interactive coding agent CLI |
| **[@reitaard/repi-tui](packages/tui)** | Terminal UI library with differential rendering |
