import type { Api, Model, ModelsStoreEntry, Provider } from "@reitaard/recode-ai";
...
/** Add a persisted catalog overlay to a static built-in provider using an explicit service URL. */
