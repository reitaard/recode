...
import type { RetryCallbacks } from "@reitaard/recode-ai";
import type {
	AssistantMessage,
	ImageContent,
	Message,
...
export class AgentSession {
	...
	/** Snapshot the minimal locked runtime profile Recode currently gives Aizen. */
	...
	exportToJsonl(outputPath?: string): string {
		...
		const filePath = resolvePath(outputPath ?? `recode-session-${reference}.jsonl`, process.cwd());
