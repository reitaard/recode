...
import type { AgentMessage, ThinkingLevel } from "@reitaard/recode-agent-core";
...
export interface RpcClientOptions {
	/** Path to the RPC executable entry point (default: package-local rpc-entry.js) */
	cliPath?: string;
...
export class RpcClient {
	...
	async start(): Promise<void> {
		...
		const cliPath = this.options.cliPath ?? fileURLToPath(new URL("../../rpc-entry.js", import.meta.url));
		const args: string[] = [];
