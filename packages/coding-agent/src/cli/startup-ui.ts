import { ProcessTerminal, setKeybindings, type TUI, TuiMainScreen } from "@reitaard/recode-tui";
...
const OFFICIAL_PACKAGE_NAME = "@reitaard/recode-coding-agent";
const OFFICIAL_APP_NAME = "recode";
// `.pi` remains the established on-disk compatibility contract.
