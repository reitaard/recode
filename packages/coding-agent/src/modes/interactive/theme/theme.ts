...
import type { EditorTheme, MarkdownTheme, RgbColor, SelectListTheme, SettingsListTheme } from "@reitaard/recode-tui";
...
const THEME_KEY = Symbol.for("@reitaard/recode-coding-agent:theme");
