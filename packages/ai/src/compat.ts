 ...
 *
 * Existing apps switch imports from "@reitaard/recode-ai" to
 * "@reitaard/recode-ai/compat" unchanged; new code uses `createModels()`
...
/** @deprecated Static catalog read. Use `getBuiltinModel` from "@reitaard/recode-ai/providers/all" or `Models.getModel()`. */
export const getModel = getBuiltinModel;

/** @deprecated Static catalog read. Use `getBuiltinModels` from "@reitaard/recode-ai/providers/all" or `Models.getModels()`. */
export const getModels = getBuiltinModels;

/** @deprecated Static catalog read. Use `getBuiltinProviders` from "@reitaard/recode-ai/providers/all" or `Models.getProviders()`. */
