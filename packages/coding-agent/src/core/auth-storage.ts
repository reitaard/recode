...
import type { Credential, CredentialInfo, CredentialStore } from "@reitaard/recode-ai";
import { findEnvKeys, getEnvApiKey, type OAuthCredentials, type OAuthLoginCallbacks } from "@reitaard/recode-ai/compat";

type OAuthProviderId = string;

import { getOAuthApiKey, getOAuthProvider, getOAuthProviders } from "@reitaard/recode-ai/oauth";
